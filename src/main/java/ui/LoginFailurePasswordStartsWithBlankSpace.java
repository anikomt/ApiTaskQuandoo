 ...
 * Status: Negative
 * Description: Logging in on a given form, providing correct username and correct password starting with a blank space.
...
public class LoginFailurePasswordStartsWithBlankSpace {
